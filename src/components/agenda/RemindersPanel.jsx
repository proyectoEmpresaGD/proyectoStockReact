    ...
    return (
        <section className="bg-white shadow rounded-xl border border-slate-100 px-5 py-4 space-y-4">
            <header className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 className="text-lg font-semibold text-slate-900">Recordatorios para no olvidar visitas</h2>
            ...
            {!hasReminders && (
                <p className="text-sm text-slate-500">
                    No hay recordatorios pendientes en las próximas 24 horas. Programa nuevas visitas o descansa sabiendo que estás al día.
                </p>
            )}
                ...
                return (
                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-slate-600">{window.description}</span>
                        </div>
            ...
            {!supportsNotifications && (
                <p className="text-xs text-slate-400">
                    Tu navegador no soporta notificaciones push. Mantén esta sección abierta para seguir los recordatorios.
                </p>
            )}
        </section>
    );
