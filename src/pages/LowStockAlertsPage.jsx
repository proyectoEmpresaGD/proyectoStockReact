    ...
    return (
        <PageShell maxWidth="max-w-6xl" className="mt-16 sm:mt-20">
            ...
            <header className="mb-8 text-center ">
                <h1 className="mb-2 text-2xl font-semibold tracking-tight text-slate-900 md:text-3xl">📦 Alertas de Stock Bajo</h1>
                <p className="text-slate-500">Actualizado: {today}</p>
            ...
            {!loading && !error && (
                <>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                        <div className="rounded-2xl border border-yellow-200 bg-yellow-50 p-4 shadow-sm sm:p-5 flex items-center">
                            <FaBoxes className="text-yellow-500 text-2xl mr-3 sm:text-3xl sm:mr-4" />
                            <div>
                        ...
                        <div className="rounded-2xl border border-green-200 bg-green-50 p-4 shadow-sm sm:p-5 flex items-center">
                            <FaBook className="text-green-500 text-2xl mr-3 sm:text-3xl sm:mr-4" />
                            <div>
                        ...
                        <div className="rounded-2xl border border-red-200 bg-red-50 p-4 shadow-sm sm:p-5 flex items-center">
                            <FaClipboardList className="text-red-500 text-2xl mr-3 sm:text-3xl sm:mr-4" />
                            <div>
