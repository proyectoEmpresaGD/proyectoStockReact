...
function EtiquetaPerchasEstampados() {
    ...
    const renderFormatoPercha = () => (
        <div
            ref={printRef}
            className="bg-white p-2 rounded-lg flex flex-col justify-between"
            style={{
                width: '18cm',
                height: '2cm',
                fontSize: '10px',
        ...
        >
            <div className="flex justify-between items-center ">
                ...
                <div>
                    <div className="text-content relative right-[50px] text-[10px]">
...
export default EtiquetaPerchasEstampados;
