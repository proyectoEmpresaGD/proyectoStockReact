...
function EtiquetaLibro35Ancho() {
            ...
            .map((d, index) => (
                <div key={index} style={{ display: 'flex', alignItems: 'center', marginRight: '3px' }}>
                    <img
                        ...
                        title={d}
                    />
                    <span style={{ fontSize: '9px', marginBottom: '12px', marginTop: '6px' }}>{d}</span>
                </div>
            ));
    };
    ...
    const handlePrint = async () => {
        ...
        const options = {
            ...
            jsPDF: { unit: 'cm', format: [26, 4], orientation: 'landscape' }, // ✅ 26cm ancho
        };
    ...
    const renderEtiqueta = () => (
        ...
        >
            ...
            <div className="text-content mb-3   text-[9px] grid grid-cols-4 gap-2">
                ...
                <div className="text-content text-[10px] relative top-[46px] left-[20px]">
                ...
                <div className="flex flex-col items-end justify-between mt-[10px]">
    ...
    return (
        <div className="container mx-auto p-6 max-w-5xl bg-gray-100 rounded-lg shadow-md">
            <h1 className="text-4xl font-bold mb-8 text-center text-blue-700">Etiqueta 26cm</h1>
...
export default EtiquetaLibro35Ancho;
